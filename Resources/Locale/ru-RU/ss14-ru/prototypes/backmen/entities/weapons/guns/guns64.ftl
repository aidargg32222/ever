...
ent-ParticlesFireNRFHELL = струя реактивного пламени
    .desc = Очень горячо!
    .suffix = Адское Пламя
ent-WeaponShotguntrenchgunL4034 = L-4034
    .desc = Шестризарядное помповое ружьё. Используется для охоты на преступников. Заряжается .50 калибром.
    .suffix = Дробовик
ent-WeaponShotguntrenchgunL4034NonLethal = { ent-WeaponShotguntrenchgunL4034 }
    .desc = { ent-WeaponShotguntrenchgunL4034 }
    .suffix = Нелетальное
ent-WeaponShotgunSpas12 = SPAS 12
    .desc = Используется властями для борьбы со всякими вредителями. Заряжается .50 калибром.
    .suffix = Нелетальное
ent-WeaponShotgunXM1014 = XM1014
    .desc = Стандартное оружие, стоящее на вооружении ОПЗ. Заряжается .50 калибром.
    .suffix = Дробовик
